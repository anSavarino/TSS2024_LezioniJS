...
let libri = [
    new Libro("Harry Potter", "https://m.media-amazon.com/images/I/718kKmxQBWL._AC_UF1000,1000_QL80_.jpg", "J.K. Rowling","Un maghetto che fa le magie",
    ["Harry Potter","Ron Weasley","Hermione Granger"], 21),
    new Libro("Il Mondo Al contrario", "https://m.media-amazon.com/images/I/61VfPKjuuPL._SY466_.jpg","Roberto Vannacci", "“Il Mondo al contrario” vuole infatti provocatoriamente rappresentare lo stato d’animo di tutti quelli che, come me, percepiscono negli accadimenti di tutti i giorni una dissonante e fastidiosa tendenza generale che si discosta ampiamente da quello che percepiamo come sentire comune, come logica e razionalità",
    ["Gli italiani stupidi", "Quello scemo di Vannacci"], 19.76),
    new Libro("Io sono Giorgia. Le mie radici le mie idee","https://m.media-amazon.com/images/I/710MUrNAofL._SL1500_.jpg","Giorgia Meloni","In questo libro, Giorgia Meloni parla per la prima volta di sé a tutto tondo.",
    ["Giorgia Meloni", "Il signora Presidente"],17.10),
    new Libro("Perché Salvini Merita Fiducia Rispetto E Ammirazione", "https://m.media-amazon.com/images/I/6175fdtYd6L._SL1360_.jpg","Alex Green", "Questo libro è pieno di pagine vuote. Nonostante anni di ricerche, non abbiamo potuto trovare niente da dire su questo argomento, così per favore sentitevi liberi di usare questo libro per gli appunti.",
    ["Matteo Salvini"], 6.99),
    new Libro("Quiz da fare mentre fai la cacca", "https://m.media-amazon.com/images/I/613d1GISrkL._SL1000_.jpg", "Nathan Haselbauer","Confrontati con una delle menti più geniali al mondo in una sfida a colpi di indovinelli! Questo libro contiene 201 quiz, da affrontare senza alcun bisogno di carta e penna e pensati per poter essere risolti in non più di due minuti",
    ["Stitici"], 5.99)
]
